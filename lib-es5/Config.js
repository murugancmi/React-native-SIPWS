...
var checks = {
  ...
  optional: {
    ...
    set_registration_timeout: function set_registration_timeout(_set_registration_timeout) {
      if (typeof _set_registration_timeout === 'boolean') {
        return _set_registration_timeout;
      }
    }
  }
};
