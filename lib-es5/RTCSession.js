...
var _require = require('react-native-webrtc'),
    registerGlobals = _require.registerGlobals;
...
module.exports = function (_EventEmitter) {
  ...
  _createClass(RTCSession, [{
    ...
    value: function _createLocalDescription(type, constraints) {
      ...
      var readyCalled = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
      ...
      .then(function (desc) {
        ...
        return new Promise(function (resolve) {
          ...
          var ready = function ready() {
            ...
            // resolve(e.sdp);
            resolve(_this14._createLocalDescription(type, constraints, true)); // gotta recreate the SDP otherwise it doesnt get updated with candidates
          };
